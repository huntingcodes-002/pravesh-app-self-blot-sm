...
export default function Step11EvaluationPage() { 
  ...
  // State maps to the required fields for step11_eval
  ...
  const handlePrevious = () => {
    // Navigate back to the new Step 10 (Payments)
  ...
  return (
    <DashboardLayout 
        ...
        showExitButton={true}
        // Save form data and navigate to leads on exit
        onExit={() => {
             if (!currentLead) { router.push('/leads'); return; }
             updateLead(currentLead.id, { formData: { ...currentLead.formData, step11_eval: { ...formData } }, currentStep: 11 });
             router.push('/leads');
        }}
    >
      <div className="max-w-2xl mx-auto">
        <ProgressBar currentStep={11} totalSteps={totalSteps} /> 
